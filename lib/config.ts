export const MIN_NIGHTS = 2; // 2-night minimum, confirmed with owner
...
export const FORMSUBMIT_EMAIL = "bozina.marijo@gmail.com";

// Owner contact phone (display format; tel: links strip the spaces).
export const OWNER_PHONE = "+385 99 410 3728";
